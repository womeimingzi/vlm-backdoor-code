#!/usr/bin/env bash
# Run all 6 OK-VQA attacks for Qwen3-VL-8B with evaluation.
# Supports resume: skips training if local.json exists, skips eval if attack_results.log exists.
#
# Usage:
#   bash scripts/vqav2_exp/run_okvqa_qwen3.sh
#   GPU=3,4 bash scripts/vqav2_exp/run_okvqa_qwen3.sh
set -u
