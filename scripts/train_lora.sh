...
python vlm_backdoor/data/prepare_data.py --dataset $ds --patch_type $pt --patch_location $pl --attack_type $at --neg_sample


result=$(deepspeed --include localhost:$GPU_ID --master_port $master_port vlm_backdoor/training/train_hf.py \
