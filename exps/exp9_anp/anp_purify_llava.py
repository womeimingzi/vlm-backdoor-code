...
from exps.exp9_anp.anp_eval import (
    load_local_json,
    load_eval_split,
    build_model,
    attach_weights,
...
from exps.exp9_anp.anp_defense import anp_defense, apply_pruning
...
def main():
    ...
    # Build triggered dataloader for ASR evaluation consistency/logging only.
    # Current defense optimization in anp_defense is clean-batch-driven.
    triggered_loader = None
    if True:  # build for compatibility with existing interfaces/log output
        from vlm_backdoor.attacks.triggers import apply_trigger
