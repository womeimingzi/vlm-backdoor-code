...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=6,7 python exps/exp9_anp/anp_purify_qwen3vl.py \
...
def main():
    ...
    from exps.exp1b_projection.exp1b_projection import build_eval_cache
    ...
    if not args.no_eval:
        ...
        # Reload backdoor weights (evaluate_qwen3vl_adapter modifies in-place)
