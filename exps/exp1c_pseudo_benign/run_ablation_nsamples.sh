...
#   bash exps/exp1c_pseudo_benign/run_ablation_nsamples.sh
#
# 也可以只跑部分：
#   bash exps/exp1c_pseudo_benign/run_ablation_nsamples.sh llava          # 只跑 LLaVA
#   bash exps/exp1c_pseudo_benign/run_ablation_nsamples.sh qwen3vl       # 只跑 Qwen3-VL
#   bash exps/exp1c_pseudo_benign/run_ablation_nsamples.sh llava badnet  # 只跑 LLaVA+BadNet
...
GPUS="${GPUS:-4,5,6,7}"
SCRIPT="exps/exp1c_pseudo_benign/run_ablation_nsamples.py"
...
echo "  exps/exp1c_pseudo_benign/ablation_nsamples/llava_badnet/ablation_results.json"
echo "  exps/exp1c_pseudo_benign/ablation_nsamples/llava_issba/ablation_results.json"
echo "  exps/exp1c_pseudo_benign/ablation_nsamples/qwen3vl_badnet/ablation_results.json"
echo "  exps/exp1c_pseudo_benign/ablation_nsamples/qwen3vl_issba/ablation_results.json"
