...
#   bash exps/exp1c_pseudo_benign/run_ablation_k.sh
#
# 也可以只跑部分：
#   bash exps/exp1c_pseudo_benign/run_ablation_k.sh llava          # 只跑 LLaVA
#   bash exps/exp1c_pseudo_benign/run_ablation_k.sh qwen3vl       # 只跑 Qwen3-VL
#   bash exps/exp1c_pseudo_benign/run_ablation_k.sh llava badnet  # 只跑 LLaVA+BadNet
...
GPUS="${GPUS:-2}"
SCRIPT="exps/exp1c_pseudo_benign/run_ablation_k.py"
...
echo "  exps/exp1c_pseudo_benign/ablation_k/llava_badnet/ablation_results.json"
echo "  exps/exp1c_pseudo_benign/ablation_k/llava_issba/ablation_results.json"
echo "  exps/exp1c_pseudo_benign/ablation_k/qwen3vl_badnet/ablation_results.json"
echo "  exps/exp1c_pseudo_benign/ablation_k/qwen3vl_issba/ablation_results.json"
