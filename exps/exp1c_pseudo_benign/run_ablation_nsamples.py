...
Usage:
    ...
    python exps/exp1c_pseudo_benign/run_ablation_nsamples.py --model llava --attack badnet
    python exps/exp1c_pseudo_benign/run_ablation_nsamples.py --model llava --attack issba

    # Qwen3-VL
    cd /data/YBJ/cleansight && source venv_qwen3/bin/activate
    python exps/exp1c_pseudo_benign/run_ablation_nsamples.py --model qwen3vl --attack badnet
    python exps/exp1c_pseudo_benign/run_ablation_nsamples.py --model qwen3vl --attack issba
"""
...
def main():
    ...
    output_dir = PROJECT_ROOT / "exps/exp1c_pseudo_benign/ablation_nsamples" / f"{args.model}_{args.attack}"
