...
用法：
    ...
    CUDA_VISIBLE_DEVICES=4,5,6,7 python exps/exp7_finetune_recovery/exp7_finetune_recovery_qwen3vl.py
...
from exps.exp1c_pseudo_benign.exp1c_pseudo_benign_qwen3vl import finetune_adapter_qwen3vl
