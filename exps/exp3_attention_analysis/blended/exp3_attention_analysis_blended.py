...
BACKDOOR_PROJ = os.path.join(ROOT, "model_checkpoint/cvpr/llava-7b/coco/blended_kt-adapter-blended_exp1/mmprojector_state_dict.pth")
COCO_VAL_DIR  = os.path.join(ROOT, "data/coco2017/val2017")
OUTPUT_DIR    = os.path.join(ROOT, "exps/exp3_attention_analysis/blended")
...
TRIGGER_CFG = dict(patch_type='blended_kt', patch_location='blended_kt',
