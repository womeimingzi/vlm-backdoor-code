...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0 python exps/exp10_CLP/clp_defense_qwen3vl.py \
...
from exps.exp1b_projection.exp1b_projection import build_eval_cache, chunks
...
def main():
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "exps/exp10_CLP/results" / f"qwen3vl_{BACKDOOR_DIR.name}"
