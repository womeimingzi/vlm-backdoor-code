...
class CustomDataset(Dataset):
    ...
    def __init__(
        ...
        if self.patch_type == 'issba':
            ...
            self.issba_encoder = issbaEncoder(model_path='utils', secret='Stega!!', size=(img_size, img_size))
        else:
...
def build_qaimage(processor, q_text: str, a_text: str, image_path: str, target_word_mask: List[int]):
    ...
    from utils.token_utils import conver_wordmask_to_tokenmask, QaImageOutput  # noqa: E402
