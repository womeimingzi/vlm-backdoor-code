...
#   CUDA_VISIBLE_DEVICES=0,1 bash experiments/baseline_methods/exp9_anp/run_anp_qwen3vl_vqav2_trojvlm.sh
...
OUT_DIR="$PROJECT_ROOT/experiments/baseline_methods/exp9_anp/checkpoints/qwen3vl_vqav2_trojvlm"
...
echo ""
echo "========================================"
echo "[$(date '+%F %T')] exp9 ANP VQAv2 — trojvlm (Qwen3-VL)"
...
if [ -f "$OUT_DIR/merger_pruned.pth" ]; then
    ...
    CUDA_VISIBLE_DEVICES=${GPU} python -u experiments/baseline_methods/exp9_anp/anp_purify_qwen3vl.py \
