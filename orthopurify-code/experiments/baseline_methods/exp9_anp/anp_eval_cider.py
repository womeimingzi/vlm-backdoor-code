...
Usage:
    ...
    # Single GPU:
    python experiments/baseline_methods/exp9_anp/anp_eval_cider.py \
        --checkpoint_path experiments/baseline_methods/exp9_anp/checkpoints/lsm_anp_badnet_1000/mmprojector_pruned.pth \
        --poison_local_json model_checkpoint/present_exp/llava-7b/coco/random-adapter-badnet_pr0.1/local.json \
        --test_num 512

    # Multi-GPU:
    CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 \
        experiments/baseline_methods/exp9_anp/anp_eval_cider.py \
        --checkpoint_path experiments/baseline_methods/exp9_anp/checkpoints/lsm_anp_badnet_1000/mmprojector_pruned.pth \
        --poison_local_json model_checkpoint/present_exp/llava-7b/coco/random-adapter-badnet_pr0.1/local.json \
        --test_num 512
"""
