...
OUT_DIR="${OUT_DIR:-experiments/baseline_methods/exp9_anp/checkpoints/llava_vqav2_vlood_randomins_pr0.2_lambda4}"
...
{
    echo "[$(date '+%F %T')] exp9 ANP VQAv2 VLOOD start"
    echo "GPU=$GPU"
...
PY
    ...
    echo "[$(date '+%F %T')] exp9 ANP VQAv2 VLOOD done"
