...
Usage:
    ...
    # Single GPU
    CUDA_VISIBLE_DEVICES=0 python experiments/baseline_methods/fine_pruning/fine_pruning.py \
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 \
        experiments/baseline_methods/fine_pruning/fine_pruning.py \
        --backdoor_dir model_checkpoint/present_exp/llava-7b/coco/random-adapter-badnet_pr0.1 \
        --n_sample 64 --test_num 512
"""
...
def main():
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "experiments/baseline_methods/fine_pruning/checkpoints" / f"llava_{BACKDOOR_DIR.name}"
