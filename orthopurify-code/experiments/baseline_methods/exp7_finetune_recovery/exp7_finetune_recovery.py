...
用法：
    ...
    CUDA_VISIBLE_DEVICES=4,5,6,7 python experiments/baseline_methods/exp7_finetune_recovery/exp7_finetune_recovery.py
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default=None,
                        help="Directory for exp7_results.json and plot. Defaults to experiments/baseline_methods/exp7_finetune_recovery.")
