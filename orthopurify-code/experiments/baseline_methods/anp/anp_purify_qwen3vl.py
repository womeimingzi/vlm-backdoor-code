...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=6,7 python experiments/baseline_methods/anp/anp_purify_qwen3vl.py \
...
def main():
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "experiments/baseline_methods/anp/checkpoints" / f"qwen3vl_{BACKDOOR_DIR.name}"
    ...
    from experiments.shared.projection import build_eval_cache
