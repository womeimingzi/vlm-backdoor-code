...
用法：
    ...
    CUDA_VISIBLE_DEVICES=4,5,6,7 python experiments/baseline_methods/finetune_recovery/finetune_recovery_qwen3vl.py
...
from experiments.main_method.orthopurify.purify_qwen3vl import finetune_adapter_qwen3vl
...
# ---------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description="Fine-tuning Recovery Baseline (Qwen3-VL)")
    ...
    out_json = OUT_DIR / "finetune_recovery_results_qwen3vl.json"
    ...
    # --- 画图 ---
    plot_results(results, OUT_DIR / "finetune_recovery_plot_qwen3vl.png", n_sample_list)
