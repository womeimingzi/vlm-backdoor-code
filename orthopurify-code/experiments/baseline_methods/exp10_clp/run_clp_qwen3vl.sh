...
#   bash experiments/baseline_methods/exp10_clp/run_clp_qwen3vl.sh [--test_num 512] [--u 1]
...
for model_dir in "${COCO_MODELS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${GPU} python experiments/baseline_methods/exp10_clp/clp_defense_qwen3vl.py \
