...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0 python experiments/baseline_methods/exp10_clp/clp_defense_qwen3vl.py \
...
from experiments.shared.exp1b_projection import build_eval_cache, chunks
...
def main():
    parser = argparse.ArgumentParser(
        description="exp10 CLP: Channel Lipschitz Pruning defense (Qwen3-VL)"
    )
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "experiments/baseline_methods/exp10_clp/results" / f"qwen3vl_{BACKDOOR_DIR.name}"
