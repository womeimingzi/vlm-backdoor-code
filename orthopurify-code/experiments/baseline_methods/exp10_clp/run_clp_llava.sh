...
#   bash experiments/baseline_methods/exp10_clp/run_clp_llava.sh [--test_num 512] [--u 1]
...
for model_dir in "${VQAV2_MODELS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${GPU} python experiments/baseline_methods/exp10_clp/clp_defense.py \
