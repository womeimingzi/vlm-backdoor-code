...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0 python experiments/baseline_methods/exp10_clp/clp_defense.py \
    ...
    CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 experiments/baseline_methods/exp10_clp/clp_defense.py \
        --backdoor_dir model_checkpoint/present_exp/llava-7b/coco/random-adapter-badnet_pr0.1 \
        --test_num 512
"""
...
def main():
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "experiments/baseline_methods/exp10_clp/results" / f"llava_{BACKDOOR_DIR.name}"
