...
Usage:
    ...
    # Single GPU
    CUDA_VISIBLE_DEVICES=0 python experiments/baseline_methods/exp8_fine_pruning/exp8_fine_pruning_qwen3vl.py \
    ...
    CUDA_VISIBLE_DEVICES=0,1 python experiments/baseline_methods/exp8_fine_pruning/exp8_fine_pruning_qwen3vl.py \
        --backdoor_dir model_checkpoint/present_exp/qwen3-vl-8b/coco/random-adapter-qwen3_badnet_pr0.1 \
...
def main():
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "experiments/baseline_methods/exp8_fine_pruning/checkpoints" / f"qwen3vl_{BACKDOOR_DIR.name}"
