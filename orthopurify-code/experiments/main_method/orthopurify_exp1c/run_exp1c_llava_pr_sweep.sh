...
#   bash experiments/main_method/orthopurify_exp1c/run_exp1c_llava_pr_sweep.sh [--skip_eval] [--test_num 256]
...
for PR in "${POISON_RATES[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${GPUS} python experiments/main_method/orthopurify_exp1c/exp1c_pseudo_benign.py \
