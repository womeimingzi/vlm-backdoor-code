...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=5 python experiments/main_method/orthopurify_exp1c/exp1c_pseudo_benign_qwen3vl.py \
...
def main():
    ...
    OUTPUT_DIR = PROJECT_ROOT / "experiments/main_method/orthopurify_exp1c/checkpoints" / f"qwen3vl_{BACKDOOR_DIR.name}"
