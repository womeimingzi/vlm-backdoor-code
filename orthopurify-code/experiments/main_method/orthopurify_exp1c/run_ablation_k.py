...
Usage:
    ...
    python experiments/main_method/orthopurify_exp1c/run_ablation_k.py --model llava --attack badnet
    python experiments/main_method/orthopurify_exp1c/run_ablation_k.py --model llava --attack issba

    # Qwen3-VL
    cd /data/YBJ/cleansight && source venv_qwen3/bin/activate
    python experiments/main_method/orthopurify_exp1c/run_ablation_k.py --model qwen3vl --attack badnet
    python experiments/main_method/orthopurify_exp1c/run_ablation_k.py --model qwen3vl --attack issba
"""
...
def main():
    ...
    output_dir = PROJECT_ROOT / "experiments/main_method/orthopurify_exp1c/ablation_k" / f"{args.model}_{args.attack}"
