...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=5 python experiments/main_method/orthopurify_exp1c/exp1c_pseudo_benign.py \
...
def main():
    ...
    if args.output_dir:
        ...
        OUTPUT_DIR = PROJECT_ROOT / "experiments/main_method/orthopurify_exp1c/checkpoints" / f"llava_{BACKDOOR_DIR.name}"
