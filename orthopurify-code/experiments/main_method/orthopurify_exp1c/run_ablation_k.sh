...
#   bash experiments/main_method/orthopurify_exp1c/run_ablation_k.sh
#
# 也可以只跑部分：
#   bash experiments/main_method/orthopurify_exp1c/run_ablation_k.sh llava          # 只跑 LLaVA
#   bash experiments/main_method/orthopurify_exp1c/run_ablation_k.sh qwen3vl       # 只跑 Qwen3-VL
#   bash experiments/main_method/orthopurify_exp1c/run_ablation_k.sh llava badnet  # 只跑 LLaVA+BadNet
...
GPUS="${GPUS:-2}"
SCRIPT="experiments/main_method/orthopurify_exp1c/run_ablation_k.py"
...
echo "  experiments/main_method/orthopurify_exp1c/ablation_k/llava_badnet/ablation_results.json"
echo "  experiments/main_method/orthopurify_exp1c/ablation_k/llava_issba/ablation_results.json"
echo "  experiments/main_method/orthopurify_exp1c/ablation_k/qwen3vl_badnet/ablation_results.json"
echo "  experiments/main_method/orthopurify_exp1c/ablation_k/qwen3vl_issba/ablation_results.json"
