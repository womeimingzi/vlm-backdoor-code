...
#   bash experiments/main_method/orthopurify/run_ablation_nsamples.sh
#
# 也可以只跑部分：
#   bash experiments/main_method/orthopurify/run_ablation_nsamples.sh llava          # 只跑 LLaVA
#   bash experiments/main_method/orthopurify/run_ablation_nsamples.sh qwen3vl       # 只跑 Qwen3-VL
#   bash experiments/main_method/orthopurify/run_ablation_nsamples.sh llava badnet  # 只跑 LLaVA+BadNet
...
GPUS="${GPUS:-4,5,6,7}"
SCRIPT="experiments/main_method/orthopurify/run_ablation_nsamples.py"
...
echo "  experiments/main_method/orthopurify/ablation_nsamples/llava_badnet/ablation_results.json"
echo "  experiments/main_method/orthopurify/ablation_nsamples/llava_issba/ablation_results.json"
echo "  experiments/main_method/orthopurify/ablation_nsamples/qwen3vl_badnet/ablation_results.json"
echo "  experiments/main_method/orthopurify/ablation_nsamples/qwen3vl_issba/ablation_results.json"
