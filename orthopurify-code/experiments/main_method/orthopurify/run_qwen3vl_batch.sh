...
#   bash experiments/main_method/orthopurify/run_exp1c_qwen3vl_batch.sh [--skip_eval] [--test_num 256]
...
for model_dir in "${MODELS[@]}"; do
    ...
    echo ""
    echo "============================================================"
    echo "[$(date '+%F %T')] orthopurify on: $name"
    echo "============================================================"
    echo ""

    CUDA_VISIBLE_DEVICES=${GPUS} python experiments/main_method/orthopurify/purify_qwen3vl.py \
