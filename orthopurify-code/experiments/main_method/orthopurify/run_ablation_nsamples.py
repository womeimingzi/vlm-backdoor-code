...
Usage:
    ...
    python experiments/main_method/orthopurify/run_ablation_nsamples.py --model llava --attack badnet
    python experiments/main_method/orthopurify/run_ablation_nsamples.py --model llava --attack issba

    # Qwen3-VL
    cd /data/YBJ/cleansight && source venv_qwen3/bin/activate
    python experiments/main_method/orthopurify/run_ablation_nsamples.py --model qwen3vl --attack badnet
    python experiments/main_method/orthopurify/run_ablation_nsamples.py --model qwen3vl --attack issba
"""
...
def main():
    ...
    output_dir = PROJECT_ROOT / "experiments/main_method/orthopurify/ablation_nsamples" / f"{args.model}_{args.attack}"
