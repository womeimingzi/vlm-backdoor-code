...
Usage:
    python experiments/analysis_experiments/exp11_residual_energy/exp11_weight_similarity.py \
...
def main():
    parser = argparse.ArgumentParser(description="exp11b: Weight-level similarity")
