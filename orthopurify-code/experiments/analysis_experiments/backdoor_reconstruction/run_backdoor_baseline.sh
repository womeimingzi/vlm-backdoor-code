#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
# Backdoor Reconstruction: Backdoor baseline — fine-tune ORIGINAL backdoor models (no defense)
...
echo "Backdoor Reconstruction Backdoor baseline | Start: $(date) | GPU: ${CUDA_VISIBLE_DEVICES}"
...
for attack, bd_name in [('BadNet', 'random-adapter-badnet_pr0.1'),
    ...
    f = f'experiments/analysis_experiments/backdoor_reconstruction/results/{bd_name}/Backdoor/reconstruction_results.json'
