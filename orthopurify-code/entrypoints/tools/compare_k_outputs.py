"""Quick comparison of k=10 vs k=5 purified model outputs on VQAv2."""
import sys
...
# Also get the clean (pretrained) projector state
...
# Sample 20 diverse examples
print("\n" + "="*80)
print("COMPARING OUTPUTS: Backdoor | k=10 purified | k=5 purified | Clean (pretrained)")
print("="*80)

samples = list(range(0, 100, 5))[:20]  # every 5th sample, first 20
